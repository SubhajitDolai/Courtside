      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pt-28 sm:pt-32">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-6">
            <div 
              className="flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-2xl md:rounded-3xl bg-gradient-to-br from-blue-600 to-blue-700 dark:from-blue-500 dark:to-blue-600 text-white shadow-xl cursor-pointer hover:shadow-2xl transition-shadow duration-200"
