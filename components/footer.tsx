...
export default function FooterSection() {
    ...
    const handleClick = (href: string, e: React.MouseEvent<HTMLAnchorElement>) => {
        ...
        e.preventDefault();
        start(); // Start global loading bar
        router.push(href);
    };
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    >
                        ...
                        >
                            <path
                                fill="currentColor"
                                d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4a5.8 5.8 0 0 1-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8A5.8 5.8 0 0 1 7.8 2m-.2 2A3.6 3.6 0 0 0 4 7.6v8.8C4 18.39 5.61 20 7.6 20h8.8a3.6 3.6 0 0 0 3.6-3.6V7.6C20 5.61 18.39 4 16.4 4zm9.65 1.5a1.1 1.1 0 0 1 0 2.2 1.1 1.1 0 0 1 0-2.2zM12 7.3a4.7 4.7 0 1 1 0 9.4 4.7 4.7 0 0 1 0-9.4zm0 2.2a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z"
                            />
                        </svg>
                    </a>
                </div>
